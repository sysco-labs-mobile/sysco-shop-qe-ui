...
xcodebuild test "-destination" "platform=iOS Simulator,id=48C09AF0-ECA1-473A-AA6A-57FDDDAA6F4C,OS=14.4" "-project" "SyscoShopApp/SyscoShopApp.xcodeproj" "-scheme" "SyscoShopApp-dev"
xcodebuild "-project" "SyscoShopApp/SyscoShopApp.xcodeproj"     "-scheme" "SyscoShopApp-dev" "-configuration" "Debug" "COMPILER_INDEX_STORE_ENABLE=NO" "archive" "-archivePath" "SyscoShop-dev.xcarchive"   "-sdk" "iphonesimulator14.4" "-destination" "platform=iOS Simulator,id=48C09AF0-ECA1-473A-AA6A-57FDDDAA6F4C,OS=14.4"

...
public class FilterBrandPage extends BaseTest {
    ...
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Brand\"]")
    private MobileElement brandHeader;
    ...
    private MobileElement firstBrandSelector;
}
